...
// GET route untuk menampilkan konfirmasi
Route::get('/dokumens/{dokumen}/send-to-ibub', [DokumenController::class, 'confirmSendToIbuB'])->name('dokumens.confirmSend');

// POST route untuk mengirim dokumen
...
Route::get('/api/deadline-notifications', [\App\Http\Controllers\DeadlineNotificationController::class, 'getNotifications'])
    ->name('deadline.notifications.get');
Route::post('/api/deadline-notifications/{id}/read', [\App\Http\Controllers\DeadlineNotificationController::class, 'markAsRead'])
    ->name('deadline.notifications.read');
Route::post('/api/deadline-notifications/read-all', [\App\Http\Controllers\DeadlineNotificationController::class, 'markAllAsRead'])
    ->name('deadline.notifications.readAll');
